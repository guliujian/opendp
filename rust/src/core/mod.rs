...
#[derive(Clone)]
pub struct Postprocessor<DI: Domain, DO: Domain> {
    pub input_domain: DI,
    pub output_domain: DO,
    pub function: Function<DI, DO>,
}

impl<DI: Domain, DO: Domain> Postprocessor<DI, DO> {
    pub fn new(input_domain: DI, output_domain: DO, function: Function<DI, DO>) -> Self {
        Self {
            input_domain,
            output_domain,
            function,
